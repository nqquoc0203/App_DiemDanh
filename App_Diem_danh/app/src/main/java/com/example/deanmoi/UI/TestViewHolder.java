...
public class TestViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
{
    ...
    private final TestAdapter.OnItemClickTest onItemListener;
    public final TextView TimeEventCell;
    public TestViewHolder(@NonNull View itemView, TestAdapter.OnItemClickTest onItemListener, ArrayList<LocalDate> days)
    {
        super(itemView);
